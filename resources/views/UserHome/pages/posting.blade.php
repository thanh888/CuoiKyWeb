      ...
      <div class="row">
        <div class="col-md-12 col-lg-8">
          <div class="title-single-box">
            <h1 class="title-single">Đăng bài viết</h1>
        ...
        <div class="row">
          ...
          <div class="form-group col-md-3">
              ...
              <div class="custom-file">
                  <input type="file" multiple class="form-control-file custom-file-input" placeholder=" Nhập tên sản phẩm    " name="image_path[]">
