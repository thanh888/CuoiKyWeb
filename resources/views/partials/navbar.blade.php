        ...
        <div class="collapse navbar-collapse mt-sm-0 mt-2 me-md-0 me-sm-4" id="navbar">
          ...
          <li>
                ...
                <i class="fa fa-user me-sm-1"></i>
                  <span class="d-sm-inline d-none">{{auth()->check()?auth()->user()->name:""}}</span>
								</button>
								<ul class="dropdown-menu">
									<li class="dropdown-item"><a href="{{route('admin.loguot')}}"> <i font-size="100px;" class="bi bi-box-arrow-in-right"></i>
                  <span class="d-sm-inline d-none">Logout</span></li>
								</ul>
									</div>
