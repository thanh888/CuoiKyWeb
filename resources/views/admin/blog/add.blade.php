...
<div class="content-wrapper">
    <div class="content">
        <div class="container-fluid">
            <form action="{{ route('adminblog.addstore') }}" method="post" enctype="multipart/form-data">
                @csrf
                <div class="row">
                ...
                <div class="row">
                    <div class="form-group col-md-3">
                        <label>Tiêu đề </label>
                        <div class="" id="" name="">
                            <input class="border-radius-lg shadow-sm" name="title" type="text">
                        </div>
                    </div>
                    <div class="form-group col-md-3">
                        <label>Sologan </label>
                        <div class="" id="" name="">
                            <input class="border-radius-lg shadow-sm" name="sologan" type="text">
                        </div>
                    </div>
                </div>
                <div class="row">
                ...
                <button type="submit" class="btn btn-success update add_delivery">Đăng blog</button>
            </form>
        </div>
    </div>
</div>
